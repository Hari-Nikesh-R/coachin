package com.example.coachin.dto;
...
public class PlayerDto {
    ...
    public PlayerDto(String id, String name, int runs, int wickets, int catches, int jerseyNumber, double averageRunRate, double economy, int age) {
        this.id = id;
        this.name = name;
        this.runs = runs;
